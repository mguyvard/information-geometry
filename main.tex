...
%- Corollaire 3.5.4. Donner les grandes lignes de la preuve de ce corollaire
%- 3.5.
%- Théorème 6.4.3. Voir comment cela s'applique à l'exemple que j'ai choisi

% I notions de géom Riemannienne (métrique, géodésique, exemple la sphère ou le tore) II Métrique de Fisher Géodésiques associée Exemples III Entropie de l’information (max d’entropie, hessienne de l’entropie vs métrique de Fisher, pourquoi la métrique de Fisher est naturelle) The 6.4.3 simplifié IV Kullback–Leibler relative entropie (Proposition 4.4.2 + exemple)=
